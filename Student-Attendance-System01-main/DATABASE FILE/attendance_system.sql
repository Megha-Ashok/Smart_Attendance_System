...
VALUES (162, 'ASDFLKJ', '1', '2', '1', '1', '2020-11-01'),
...
INSERT INTO `tblclass` (`Id`, `className`)
VALUES (1, 'Seven'),
  (3, 'Eight'),
  (4, 'Nine');
-- --------------------------------------------------------
...
INSERT INTO `tblclassarms` (`Id`, `classId`, `classArmName`, `isAssigned`)
VALUES (2, '1', 'S1', '1'),
  (4, '1', 'S2', '1'),
  (5, '3', 'E1', '1'),
  (6, '4', 'N1', '1'),
...
VALUES (1, '2021/2022', '1', '1', '2022-10-31'),
...
INSERT INTO `tblterm` (`Id`, `termName`)
VALUES (1, 'First'),
  (2, 'Second'),
  (3, 'Third');
--
